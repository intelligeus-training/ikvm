...
{
	public sealed class EmitIntrinsicContext
	{
		public readonly MethodWrapper Method;
		public readonly DynamicTypeWrapper.FinishContext Context;
		public readonly CodeEmitter Emitter;
		public readonly CodeInfo ma;
		public readonly int OpcodeIndex;
		public readonly MethodWrapper Caller;
		public readonly ClassFile ClassFile;
		public readonly Instruction[] Code;
		public readonly InstructionFlags[] Flags;
		public bool NonLeaf = true;

		public EmitIntrinsicContext(MethodWrapper method, 
										DynamicTypeWrapper.FinishContext context, 
										CodeEmitter ilgen, 
										CodeInfo ma, 
										int opcodeIndex, 
		...
		public bool MatchRange(int offset, int length)
		{
	...
	public static class Intrinsics
	{
		...
		private struct IntrinsicKey : IEquatable<IntrinsicKey>
		{
			...
			public IntrinsicKey(string className, string methodName, string methodSignature)
			{
			...
			public IntrinsicKey(MethodWrapper mw)
			{
		...
		public static bool IsIntrinsic(MethodWrapper mw)
		{
		...
		public static bool Emit(EmitIntrinsicContext context)
		{
		...
		public static bool IsSupportedArrayTypeForUnsafeOperation(TypeWrapper tw)
		{
			return tw.IsArray
				&& !tw.IsGhostArray
		...
		public static MethodInfo MakeExchange(Type type)
		{
