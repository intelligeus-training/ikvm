...
public struct LocalVarInfo
{
	...
	public LocalVarInfo(CodeInfo ma, ClassFile classFile, ClassFile.Method method, UntangledExceptionTable exceptions, MethodWrapper mw, ClassLoaderWrapper classLoader)
	{
	...
	public LocalVar GetLocalVar(int instructionIndex)
	{
		return localVars[instructionIndex];
	}

	public LocalVar[] GetLocalVarsForInvokeSpecial(int instructionIndex)
	{
		return invokespecialLocalVars[instructionIndex];
	}

	public LocalVar[] GetAllLocalVars()
	{
		return allLocalVars;
	}
	...
	public struct FindLocalVarState
	{
		public bool changed;
		public FindLocalVarStoreSite[] sites;

		public void Store(int instructionIndex, int localIndex)
		{
		...
		public void Merge(FindLocalVarState state)
		{
			if (sites == null)
			{
				sites = state.sites;
	...
	public struct FindLocalVarStoreSite
	{
		private int[] data;
		...
		public void Add(int instructionIndex)
		{
			if (data == null)
			{
