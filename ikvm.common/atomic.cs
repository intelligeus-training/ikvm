...
public static class AtomicReferenceFieldUpdaterEmitter
{
	public static bool Emit(DynamicTypeWrapper.FinishContext context, 
								TypeWrapper wrapper, 
								CodeEmitter ilgen, 
								ClassFile classFile, 
								int i, 
	...
	public static void EmitImpl(TypeBuilder tb, FieldInfo field)
	{
	...
	public static MethodInfo MakeCompareExchange(Type type)
	{
...
public static class InterlockedMethods
{
