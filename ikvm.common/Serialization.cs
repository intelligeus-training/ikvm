...
namespace IKVM.Internal
{
	...
	public static class Serialization
	{
		...
		public static bool IsISerializable(TypeWrapper wrapper)
		{
		...
		public static MethodBuilder AddAutomagicSerialization(DynamicTypeWrapper wrapper, TypeBuilder typeBuilder)
		{
		...
		public static MethodBuilder AddAutomagicSerializationToWorkaroundBaseClass(TypeBuilder typeBuilderWorkaroundBaseClass, MethodBase baseCtor)
		{
		...
		public static void MarkSerializable(TypeBuilder tb)
		{
			tb.SetCustomAttribute(serializableAttribute);
		}

		public static void AddGetObjectData(TypeBuilder tb)
		{
