...
public static partial class MethodHandleUtil
{
	...
	public static bool IsPackedArgsContainer(Type type)
	{
		return type.IsGenericType
			&& type.GetGenericTypeDefinition() == typeofMHA;
	}

	public static Type CreateMethodHandleDelegateType(TypeWrapper[] args, TypeWrapper ret)
	{
	...
	public static Type CreateMemberWrapperDelegateType(TypeWrapper[] args, TypeWrapper ret)
	{
		Type[] typeArgs = new Type[args.Length];
		for (int i = 0; i < args.Length; i++)
		{
	...
	public static Type CreateDelegateType(Type[] types, Type retType)
	{
	...
	public static Type AsBasicType(TypeWrapper tw)
	{
	...
	public static bool HasOnlyBasicTypes(TypeWrapper[] args, TypeWrapper ret)
	{
	...
	public static int SlotCount(TypeWrapper[] parameters)
	{
		int count = 0;
